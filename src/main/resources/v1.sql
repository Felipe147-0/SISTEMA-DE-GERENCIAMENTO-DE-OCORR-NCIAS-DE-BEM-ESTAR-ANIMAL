...
CREATE TABLE IF NOT EXISTS `bem_estar_animal`.`listaExclusao` (
  `id_listaExclusao` BIGINT NOT NULL,
  `observacao` VARCHAR(500) NULL,
  `id_ficha` BIGINT NULL,
  PRIMARY KEY (`id_listaExclusao`),
...
CREATE TABLE IF NOT EXISTS `bem_estar_animal`.`denunciante` (
  ...
  `id_listaExclusao` BIGINT NULL,
  PRIMARY KEY (`id_denunciante`),
  INDEX `endereco_id` (`endereco_id` ASC) VISIBLE,
  INDEX `fk_denunciante_listaExclusao1_idx` (`id_listaExclusao` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_denunciante_listaExclusao1`
    FOREIGN KEY (`id_listaExclusao`)
    REFERENCES `bem_estar_animal`.`listaExclusao` (`id_listaExclusao`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
